...
- Architecture diagrams and deeper explanations of Raft, sync, and storage.
- Integration examples for specific edge/IoT deployments.

For now, also see the repo root `README.md` for quickstart and demos.
